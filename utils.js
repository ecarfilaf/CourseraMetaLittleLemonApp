...
export function getSectionListData(data) {
	...
	data.forEach((item) => {
		...
		sectionMap[item.category].push(item);
	});
	console.log('getSectionListData-sectionMap');
	//console.log(sectionMap);

	const sections = Object.keys(sectionMap).map((category) => ({
		title: category,
		data: sectionMap[category],
	}));
	console.log('getSectionListData-sections');
